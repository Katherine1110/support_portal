...
function Donation() {
  return (
    <>
      ...
      <h2>Звичайно, ми маємо де все це придбати.</h2>
      <h2>А ви можете зробити пожертву на рахунок:</h2>
      <div>
        <h3>ENEFICIARY</h3>
        <p>
      ...
      <div>
        <h3>ACCOUNT</h3>
        <p>
          Счет в банке получателя (номер пластиковой карты или текущий счет в ПриватБанке) 5168 7450
          1741 2153
        </p>
      </div>
      <div>
      ...
      <div>
        ...
        <p>Банк-корреспондент J.P.MORGAN AG, FRANKFURT AM MAIN, GERMANY SWIFT CODE/BIC: CHASDEFX</p>
      </div>
      <div>
        <h3>Валюта карты:</h3>
        <p>EUR</p>
